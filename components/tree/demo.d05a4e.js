...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>`},preview:function(){var z=c(0),q=c(63);function D(a){return D=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(l){return typeof l}:function(l){return l&&typeof Symbol=="function"&&l.constructor===Symbol&&l!==Symbol.prototype?"symbol":typeof l},D(a)}var f=E(c(0)),m=c(12),i=c(67);function E(a){return a&&a.__esModule?a:{default:a}}function T(a){return N(a)||P(a)||S(a)||K()}function K(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
