(window.webpackJsonp=window.webpackJsonp||[]).push([[200],{4072:function(L,Q,c){L.exports={"basic-controlled":c(4933),basic:c(4934),"big-data":c(4935),"customized-icon":c(4936),directory:c(4937),"drag-debug":c(4938),draggable:c(4939),dynamic:c(4940),line:c(4941),search:c(4942),"switcher-icon":c(4943),"virtual-scroll":c(4944)}},4933:function(L,Q,c){L.exports={content:{"zh-CN":[["p","\u53D7\u63A7\u64CD\u4F5C\u793A\u4F8B"]],"en-US":[["p","Controlled mode lets parent nodes reflect the status of child nodes more intelligently."]]},meta:{order:1,title:{"zh-CN":"\u53D7\u63A7\u64CD\u4F5C\u793A\u4F8B","en-US":"Controlled Tree"},filename:"components/tree/demo/basic-controlled.md",id:"components-tree-demo-basic-controlled"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var z=c(0),q=c(64),D=c(12),f=m(c(0));function m(N){return N&&N.__esModule?N:{default:N}}for(var i=[],E=0;E<100;E+=1){for(var T=[],K=0;K<100;K+=1)T.push({title:"child ".concat(E,"-").concat(K),key:"l-".concat(E,"-").concat(K)});i.push({title:"parent ".concat(E),key:"l-".concat(E),children:T})}var S=function(){return f.default.createElement(D.Tree,{defaultExpandAll:!0,height:400,treeData:i})},P=S;return z.createElement(P)}}},4936:function(L,Q,c){L.exports={content:{"zh-CN":[["p","\u53EF\u4EE5\u9488\u5BF9\u4E0D\u540C\u7684\u8282\u70B9\u5B9A\u5236\u56FE\u6807\u3002"]],"en-US":[["p","You can customize icons for different nodes."]]},meta:{order:6,title:{"zh-CN":"\u81EA\u5B9A\u4E49\u56FE\u6807","en-US":"Customize Icon"},filename:"components/tree/demo/customized-icon.md",id:"components-tree-demo-customized-icon"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import {
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var z=c(0),q=c(64),D=c(68),f=c(12),m=i(c(0));function i(S){return S&&S.__esModule?S:{default:S}}var E=[{title:"parent 1",key:"0-0",icon:m.default.createElement(D.SmileOutlined,null),children:[{title:"leaf",key:"0-0-0",icon:m.default.createElement(D.MehOutlined,null)},{title:"leaf",key:"0-0-1",icon:function(P){var N=P.selected;return N?m.default.createElement(D.FrownFilled,null):m.default.createElement(D.FrownOutlined,null)}}]}],T=function(){return m.default.createElement(f.Tree,{showIcon:!0,defaultExpandAll:!0,defaultSelectedKeys:["0-0-0"],switcherIcon:m.default.createElement(D.DownOutlined,null),treeData:E})},K=T;return z.createElement(K)}}},4937:function(L,Q,c){L.exports={content:{"zh-CN":[["p","\u5185\u7F6E\u7684\u76EE\u5F55\u6811\uFF0C",["code","multiple"]," \u6A21\u5F0F\u652F\u6301 ",["code","ctrl(Windows)"]," / ",["code","command(Mac)"]," \u590D\u9009\u3002"]],"en-US":[["p","Built-in directory tree. ",["code","multiple"]," support ",["code","ctrl(Windows)"]," / ",["code","command(Mac)"]," selection."]]},meta:{order:7,title:{"zh-CN":"\u76EE\u5F55","en-US":"directory"},filename:"components/tree/demo/directory.md",id:"components-tree-demo-directory"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var z=c(0),q=c(64),D=c(12),f=m(c(0));function m(S){return S&&S.__esModule?S:{default:S}}var i=D.Tree.DirectoryTree,E=[{title:"parent 0",key:"0-0",children:[{title:"leaf 0-0",key:"0-0-0",isLeaf:!0},{title:"leaf 0-1",key:"0-0-1",isLeaf:!0}]},{title:"parent 1",key:"0-1",children:[{title:"leaf 1-0",key:"0-1-0",isLeaf:!0},{title:"leaf 1-1",key:"0-1-1",isLeaf:!0}]}],T=function(){var P=function(I,A){console.log("Trigger Select",I,A)},N=function(I,A){console.log("Trigger Expand",I,A)};return f.default.createElement(i,{multiple:!0,defaultExpandAll:!0,onSelect:P,onExpand:N,treeData:E})},K=T;return z.createElement(K)}}},4938:function(L,Q,c){L.exports={content:[],meta:{order:98,title:{"zh-CN":"Drag Debug","en-US":"Drag Debug"},debug:!0,filename:"components/tree/demo/drag-debug.md",id:"components-tree-demo-drag-debug"},toc:["ul"],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">'react'</span><span class="token punctuation">;</span>
