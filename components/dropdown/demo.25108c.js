...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var y=s(0),B=s(63),t=s(67),n=s(12),a=e(s(0));function e(o){return o&&o.__esModule?o:{default:o}}function l(o,c){return f(o)||h(o,c)||k(o,c)||w()}function w(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var y=s(0),B=s(63),t=s(67),n=s(12),a=e(s(0));function e(h){return h&&h.__esModule?h:{default:h}}var l=function(f){var O=f.key;n.message.info("Click on item ".concat(O))},w=a.default.createElement(n.Menu,{onClick:l,items:[{label:"1st menu item",key:"1"},{label:"2nd menu item",key:"2"},{label:"3rd menu item",key:"3"}]}),k=function(){return a.default.createElement(n.Dropdown,{overlay:w},a.default.createElement("a",{onClick:function(O){return O.preventDefault()}},a.default.createElement(n.Space,null,"Hover me, Click menu item",a.default.createElement(t.DownOutlined,null))))},i=k;return y.createElement(i)}}},4434:function(d,C,s){d.exports={content:{"zh-CN":[["p","\u5206\u5272\u7EBF\u548C\u4E0D\u53EF\u7528\u83DC\u5355\u9879\u3002"]],"en-US":[["p","Divider and disabled menu item."]]},meta:{order:2,title:{"zh-CN":"\u5176\u4ED6\u5143\u7D20","en-US":"Other elements"},filename:"components/dropdown/demo/item.md",id:"components-dropdown-demo-item"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { DownOutlined } from <span class="token string">'@ant-design/icons'</span><span class="token comment" spellcheck="true">;</span>
import { Dropdown<span class="token punctuation">,</span> Menu<span class="token punctuation">,</span> Space } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import React from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var y=s(0),B=s(63),t=s(67),n=s(12),a=e(s(0));function e(i){return i&&i.__esModule?i:{default:i}}var l=a.default.createElement(n.Menu,{items:[{label:a.default.createElement("a",{href:"https://www.antgroup.com"},"1st menu item"),key:"0"},{label:a.default.createElement("a",{href:"https://www.aliyun.com"},"2nd menu item"),key:"1"},{type:"divider"},{label:"3rd menu item",key:"3"}]}),w=function(){return a.default.createElement(n.Dropdown,{overlay:l,trigger:["click"]},a.default.createElement("a",{onClick:function(f){return f.preventDefault()}},a.default.createElement(n.Space,null,"Click me",a.default.createElement(t.DownOutlined,null))))},k=w;return y.createElement(k)}}}}]);
