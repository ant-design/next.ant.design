(window.webpackJsonp=window.webpackJsonp||[]).push([[114],{3983:function(i,x,p){i.exports={"custom-style":p(4606),duration:p(4607),hooks:p(4608),info:p(4609),loading:p(4610),other:p(4611),"render-panel":p(4612),thenable:p(4613),update:p(4614)}},4606:function(i,x,p){i.exports={content:{"zh-CN":[["p","\u4F7F\u7528 ",["code","style"]," \u548C ",["code","className"]," \u6765\u5B9A\u4E49\u6837\u5F0F\u3002"]],"en-US":[["p","The ",["code","style"]," and ",["code","className"]," are available to customize Message."]]},meta:{order:5,title:{"zh-CN":"\u81EA\u5B9A\u4E49\u6837\u5F0F","en-US":"Customized style"},filename:"components/message/demo/custom-style.md",id:"components-message-demo-custom-style"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Button<span class="token punctuation">,</span> message } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var g=p(0),B=p(66),u=d(p(0)),e=p(12);function d(k){return k&&k.__esModule?k:{default:k}}var f=function(){e.message.info("This is a normal message")},y=function(){return u.default.createElement(e.Button,{type:"primary",onClick:f},"Display normal message")},h=y;return g.createElement(h)}}},4610:function(i,x,p){i.exports={content:{"zh-CN":[["p","\u8FDB\u884C\u5168\u5C40 loading\uFF0C\u5F02\u6B65\u81EA\u884C\u79FB\u9664\u3002"]],"en-US":[["p","Display a global loading indicator, which is dismissed by itself asynchronously."]]},meta:{order:3,title:{"zh-CN":"\u52A0\u8F7D\u4E2D","en-US":"Message with loading indicator"},filename:"components/message/demo/loading.md",id:"components-message-demo-loading"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Button<span class="token punctuation">,</span> message } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import React from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
`},preview:function(){var g=p(0),B=p(66),u=p(12),e=u.message._InternalPanelDoNotUseOrYouWillBeFired,d=function(){return g.createElement(e,{content:"Hello World!",type:"error"})};return g.createElement(d)}}},4613:function(i,x,p){i.exports={content:{"zh-CN":[["p","\u53EF\u4EE5\u901A\u8FC7 then \u63A5\u53E3\u5728\u5173\u95ED\u540E\u8FD0\u884C callback \u3002\u4EE5\u4E0A\u7528\u4F8B\u5C06\u5728\u6BCF\u4E2A message \u5C06\u8981\u7ED3\u675F\u65F6\u901A\u8FC7 then \u663E\u793A\u65B0\u7684 message \u3002"]],"en-US":[["p",["code","message"]," provides a promise interface for ",["code","onClose"],". The above example will display a new message when the old message is about to close."]]},meta:{order:4,title:{"zh-CN":"Promise \u63A5\u53E3","en-US":"Promise interface"},filename:"components/message/demo/thenable.md",id:"components-message-demo-thenable"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Button<span class="token punctuation">,</span> message } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import React from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
