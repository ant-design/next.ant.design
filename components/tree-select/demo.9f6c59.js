(window.webpackJsonp=window.webpackJsonp||[]).push([[194],{4065:function(m,R,c){m.exports={async:c(4925),basic:c(4926),checkable:c(4927),multiple:c(4928),placement:c(4929),"render-panel":c(4930),status:c(4931),suffix:c(4932),treeData:c(4933),treeLine:c(4934)}},4925:function(m,R,c){m.exports={content:{"zh-CN":[["p","\u5F02\u6B65\u52A0\u8F7D\u6811\u8282\u70B9\u3002"]],"en-US":[["p","Asynchronous loading tree node."]]},meta:{order:5,title:{"zh-CN":"\u5F02\u6B65\u52A0\u8F7D","en-US":"Asynchronous loading"},filename:"components/tree-select/demo/async.md",id:"components-tree-select-demo-async"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import type { TreeSelectProps } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var w=c(0),x=c(63),k=c(12),i=r(c(0));function r(h){return h&&h.__esModule?h:{default:h}}var d=k.TreeSelect._InternalPanelDoNotUseOrYouWillBeFired,v=[{title:"Node1",value:"0-0",children:[{title:"Child Node1",value:"0-0-1"},{title:"Child Node2",value:"0-0-2"}]},{title:"Node2",value:"0-1"}],y=function(){return i.default.createElement(d,{defaultValue:"lucy",style:{width:"100%"},treeData:v})},S=y;return w.createElement(S)}}},4931:function(m,R,c){m.exports={content:{"zh-CN":[["p","\u4F7F\u7528 ",["code","status"]," \u4E3A TreeSelect \u6DFB\u52A0\u72B6\u6001\uFF0C\u53EF\u9009 ",["code","error"]," \u6216\u8005 ",["code","warning"],"\u3002"]],"en-US":[["p","Add status to TreeSelect with ",["code","status"],", which could be ",["code","error"]," or ",["code","warning"],"."]]},meta:{order:9,version:"4.19.0",title:{"zh-CN":"\u81EA\u5B9A\u4E49\u72B6\u6001","en-US":"Status"},filename:"components/tree-select/demo/status.md",id:"components-tree-select-demo-status"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Space<span class="token punctuation">,</span> TreeSelect } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import React from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
