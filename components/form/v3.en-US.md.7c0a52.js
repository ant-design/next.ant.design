(window.webpackJsonp=window.webpackJsonp||[]).push([[85],{1721:function(n,s){n.exports={content:["article",["h3","Remove Form.create"],["p","Form of v4 does not need to create context by calling ",["code","Form.create()"],". Form now has it's own data scope and you don't need ",["code","getFieldDecorator"]," anymore. Just use Form.Item directly:"],["pre",{lang:"jsx",highlighted:`<span class="token comment" spellcheck="true">// antd v3</span>
