...
export default App;
`,description:"<p>Customize render list with Tree component.</p>"}},{demo:{id:"components-transfer-demo-status"},previewerProps:{title:"Status",filename:"components/transfer/demo/status.tsx",jsx:`import React from 'react';
