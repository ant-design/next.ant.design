...
export default App;
`,description:"<p>Replace the default icon with customized text.</p>"}},{demo:{id:"components-alert-demo-banner"},previewerProps:{iframe:!0,title:"Banner",filename:"components/alert/demo/banner.tsx",jsx:`import React from 'react';
import { Alert } from 'antd';
const App = () => (
  <>
