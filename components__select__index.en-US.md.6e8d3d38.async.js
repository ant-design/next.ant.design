"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[54882],{615:function(r,o,t){t.r(o);var p=t(2143),v=t(96152),a=t(74775),l=t(5937),m=t(74399),Z=t(56140),d=t(5388),h=t(1160),f=t(95127),g=t(74418),u=t(33098),s=t(67294),e=t(66366);function i(){var c=(0,u.eL)(),n=c.texts;return(0,e.tZ)(u.dY,null,(0,e.tZ)(s.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value,(0,e.tZ)("code",null,n[2].value),n[3].value),(0,e.tZ)("li",null,n[4].value,(0,e.tZ)("a",{href:"/components/radio/"},n[5].value),n[6].value)),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(d.Z,{items:[{demo:{id:"components-select-demo-basic"},previewerProps:{title:"Basic Usage",filename:"components/select/demo/basic.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>Basic Usage.</p>"}},{demo:{id:"components-select-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/select/demo/render-panel.tsx",jsx:`import React from 'react';
